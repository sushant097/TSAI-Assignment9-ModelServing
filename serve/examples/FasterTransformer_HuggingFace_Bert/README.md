...
mv BERTSeqClassification.mar model-store/

torchserve --start --model-store model-store --models my_tc=BERTSeqClassification.mar --ncs
...
mv BERTQA.mar model-store/

torchserve --start --model-store model-store --models my_tc=BERTQA.mar --ncs
