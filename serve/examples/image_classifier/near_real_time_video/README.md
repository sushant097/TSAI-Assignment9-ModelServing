...
torchserve --start --model-store model-store --models resnet-18=resnet-18.mar --ts-config examples/image_classifier/near_real_time_video/config.properties
...
torchserve --start --model-store model-store --models resnet-18=resnet-18.mar
